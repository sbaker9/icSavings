...
def reset_db():
    ...
    a1 = Product(name="Nintendo Switch with Neon Blue and Neon Red Joy‑Con",
                 ...
                 favorite=False, category="Electronics", categoryID=2,
    ...
    a2 = Product(name="Echo Dot Kids Edition",
                 ...
                 favorite=True, category="Electronics", categoryID=2,
    ...
    a3 = Product(name="Really RAD Robots - Turbo Bot",
                 ...
                 favorite=False, category="Toys", categoryID=1,
    ...
    a4 = Product(name="Hot Wheels Toy Story 4 Bundle Vehicles, 6 Pack",
                 ...
                 favorite=True, category="Toys", categoryID=1,
    ...
    u1 = User(username="john", email="john@john.com", password="firewater")
    u2 = User(username="evan", email="evan@gmail.com", password="earthair")
